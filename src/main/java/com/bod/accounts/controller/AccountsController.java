...
import com.bod.accounts.dto.ErrorResponseDto;
import com.bod.accounts.dto.ResponseDto;
...
@Tag(
        name = "CRUD REST APIs for Accounts in Bank of Delhi",
...
public class AccountsController {
    ...
    @Operation(
            ...
            description = "REST API to create new Customer &  Account inside Bank of Delhi(BOD)"
    )
    @ApiResponses({
            @ApiResponse(
                    responseCode = "201",
